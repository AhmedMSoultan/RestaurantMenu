...
//       "com.iti.RestaurantMenu.order")
    ...
    func fetchCategories() async throws -> [String] {
        ...
        //Handling the Response then parse it and return the result
        ...
        // Optional to handel error codes like : 200 , 404 , etc
    ...
    // We defined a type alias for Int -> MinutesToPreper
